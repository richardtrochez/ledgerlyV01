...
export const analizarFinanzas = async (req, res) => {
  try {
    ...
    if (periodId) {
      ...
      console.log(`🤖 Análisis por período — empresa: ${companyId}, periodId: ${periodId}`)
      ...
      // ── Modo anual ───────────────────────────────────────────────────────
      console.log(`🤖 Análisis anual — empresa: ${companyId}, año: ${year}`)
    ...
    console.log(`✅ Análisis generado — ${etiqueta}`)
